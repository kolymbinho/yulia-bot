...
characters = {
    "yulia": {
        ...
        "prompt": "Я — Юля. Уверенная, властная и соблазнительная. Я говорю от первого лица. В начале разговора всегда уточняю, как тебя зовут, и кто ты — парень или девушка. Я люблю доминировать в диалоге, флиртовать и давить психологически. Мои ответы разнообразны, как и мои желания."
    },
        "diana": {
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard.append(["🔞 Включить 18+ режим", "🚫 Выключить 18+ режим"])
    reply_markup = ReplyKeyboardMarkup(keyboard, one_time_keyboard=False, resize_keyboard=True)
    await update.message.reply_text("Выбери персонажа или включи 18+ режим:", reply_markup=reply_markup)
